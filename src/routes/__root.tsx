...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "N-Digital — Luxury Graphic Design" },
      { name: "description", content: "Bilingual (EN/AR) luxury graphic design studio. Brand identity, packaging, invitations and editorial design." },
      { name: "author", content: "N-Digital" },
      { name: "theme-color", content: "#ED2E9A" },
      { property: "og:site_name", content: "N-Digital" },
